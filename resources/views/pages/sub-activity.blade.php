...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Master Sub Kegiatan</h4>
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('sub-activity.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Tambah Sub Kegiatan</a>
        </div><!-- end col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-sub-activity">
                    <thead>
                        <tr>
                            <th>Kode Rekening</th>
                            <th>Sub Kegiatan</th>
...
<script src="{{ url('assets/js/pages/sub-activity.js') }}"></script>
@endpush