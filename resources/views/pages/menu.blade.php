        ...
        <div class="row">
        	<div class="col-md-4">
				<div class="card-box clearfix">
					<form id="form-add">
						<h4 class="m-t-0 header-title">Tambah Baru / Update</h4>
						<hr>
						...
						<div class="form-group">
							<select name="method" class="select2" data-placeholder="Pilih Kategori Permission">
								<option></option>
						...
						<div class="form-group">
							...
							<div class="pull-right">
								<button class="btn btn-primary btn-bordered waves-effect waves-light" id="btn-add" type="button">Tambahkan ke Menu</button>
